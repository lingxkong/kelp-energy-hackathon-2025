...
import { ArrowRight, Building2, CheckIcon, Leaf, LightbulbOff, Zap } from "lucide-react"
    ...
    <div className="flex min-h-screen flex-col bg-blue-50">
      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-white">
          <div className="container px-4 md:px-6">
            <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Connect Your PG&E Account</h2>
              <p className="max-w-[85%] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Link your PG&E utility account to get personalized energy recommendations based on your actual usage
                data.
              </p>
            </div>
            <div className="mx-auto mt-8 grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2">
              <div className="flex flex-col justify-center space-y-4">
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-teal-100 text-teal-600">
                      <CheckIcon className="h-4 w-4" />
                    </div>
                    <span>Automatic data retrieval from your utility account</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-teal-100 text-teal-600">
                      <CheckIcon className="h-4 w-4" />
                    </div>
                    <span>Personalized recommendations based on your usage patterns</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-teal-100 text-teal-600">
                      <CheckIcon className="h-4 w-4" />
                    </div>
                    <span>Track your energy savings over time</span>
                  </li>
                </ul>
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Button asChild className="bg-teal-600 hover:bg-teal-700">
                    <Link href="/kelp-rating">
              ...
              <div className="mx-auto lg:ml-0 flex items-center justify-center">
                <div className="rounded-lg overflow-hidden shadow-xl">
                  <img
