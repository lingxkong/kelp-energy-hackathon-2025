...
import CustomInsights from "@/components/custom-insights"
    ...
    <div className="flex min-h-screen flex-col bg-blue-50">
      ...
      <main className="flex-1 container py-10">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight">Your Personalized Energy Insights</h1>
          <p className="text-muted-foreground mt-2">Based on your P&G utility data</p>
        </div>

        <div className="mx-auto mt-8 max-w-4xl">
          <Suspense fallback={<div>Loading insights...</div>}>
            <CustomInsights customerId={customerId} />
          </Suspense>
        </div>
      </main>
